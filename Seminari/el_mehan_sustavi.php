...
<div class="row">
		<div class="large-12 columns centered-text">
			<h2>Elektromehanički sustavi</h2>
		</div>
	</div>
    <br>
<?php
...
$sql_upit="SELECT naziv_seminara, autori, opis, alat, godina, dokument FROM seminar WHERE id_kategorije = 3 OR podkategorija=3 ORDER BY id_seminara ASC";
