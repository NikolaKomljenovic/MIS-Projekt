...
$sql_upit="SELECT naziv_seminara, autori, opis, alat, godina, dokument FROM seminar WHERE id_kategorije = 4 OR podkategorija=4 ORDER BY id_seminara ASC";
